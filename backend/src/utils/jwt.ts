...
const accessTokenSignOptions: SignOptsAndSecret = {
    expiresIn: Env.JWT_EXPRESS_IN as TimeString,
...
export const signJwtToken = (
    ...
    console.log("JWT_EXPIRES_IN =>", Env.JWT_EXPRESS_IN, typeof Env.JWT_EXPIRES_IN);
    ...
    const expiresAt = isAccessToken ? (jwt.decode(token) as JwtPayload)?.exp! * 1000
    :undefined;

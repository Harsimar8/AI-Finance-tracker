...
const envConfig = () => ({
    ...
    JWT_EXPRESS_IN: (0, get_env_1.getEnv)("JWT_EXPIRES_IN", "15m"),
    JWT_REFRESH_SECRET: (0, get_env_1.getEnv)("JWT_REFRESH_SECRET", "secret_jwt_refresh"),
    JWT_REFRESH_EXPIRES_IN: (0, get_env_1.getEnv)("JWT_REFRESH_IN", "7d"),

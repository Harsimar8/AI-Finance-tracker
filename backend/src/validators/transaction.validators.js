...
exports.baseTransactionSchema = zod_1.z.object({
    title: zod_1.z.string().min(1, "Ttile is required"),
    type: zod_1.z.enum([transaction_model_1.TransactionTypeEnum.INCOME,
    ...
    currency: zod_1.z.enum(Object.values(currency_1.CurrencyEnum)).default(currency_1.CurrencyEnum.INR),
    originalCurrency: zod_1.z.enum(Object.values(currency_1.CurrencyEnum)).optional(),
    ...
    recurringInterval: zod_1.z.enum([
    ...
    paymentMethod: zod_1.z.enum([
        transaction_model_2.PaymentMethodEnum.CARD,
        transaction_model_2.PaymentMethodEnum.BANK_TRANSFER,
        transaction_model_2.PaymentMethodEnum.MOBILE_PAYMENT,
        transaction_model_2.PaymentMethodEnum.CASH,
        transaction_model_2.PaymentMethodEnum.OTHER,
    ])
        .default(transaction_model_2.PaymentMethodEnum.CASH),
});
